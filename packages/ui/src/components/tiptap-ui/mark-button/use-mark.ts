...
// --- Icons ---
import { BoldIcon } from '@workspace/ui/components/tiptap-icons/bold-icon';
import { Code2Icon } from '@workspace/ui/components/tiptap-icons/code2-icon';
import { ItalicIcon } from '@workspace/ui/components/tiptap-icons/italic-icon';
import { StrikeIcon } from '@workspace/ui/components/tiptap-icons/strike-icon';
import { SubscriptIcon } from '@workspace/ui/components/tiptap-icons/subscript-icon';
import { SuperscriptIcon } from '@workspace/ui/components/tiptap-icons/superscript-icon';
import { UnderlineIcon } from '@workspace/ui/components/tiptap-icons/underline-icon';
