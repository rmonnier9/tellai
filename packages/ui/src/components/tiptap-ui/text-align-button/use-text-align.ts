...
// --- Icons ---
import { AlignCenterIcon } from '@workspace/ui/components/tiptap-icons/align-center-icon';
import { AlignJustifyIcon } from '@workspace/ui/components/tiptap-icons/align-justify-icon';
import { AlignLeftIcon } from '@workspace/ui/components/tiptap-icons/align-left-icon';
import { AlignRightIcon } from '@workspace/ui/components/tiptap-icons/align-right-icon';
