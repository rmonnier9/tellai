...
import { CloseIcon } from '@workspace/ui/components/tiptap-icons/close-icon';
import '@workspace/ui/components/tiptap-node/image-upload-node/image-upload-node.scss';
