...
export default function Example({ initialProduct, cta }: PricingTableProps) {
      ...
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="p-8 sm:p-12 lg:w-1/3 lg:shrink-0">
          <div className="text-center md:text-left">
            <p className="text-primary-600 text-2xl mb-2 dark:text-primary-400 font-fun">
              Just what you need
            </p>
            ...
            <div className="mb-8">
              <div className="flex items-baseline justify-center lg:justify-start gap-x-2 mb-2">
                ...
                <span className="text-lg text-gray-600 dark:text-gray-400 font-display">
                  /monthly
                </span>
              </div>
            </div>
                ...
                <div key={index} className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                    {feature.includes('Backlink Exchange') ? (
                      ...
                      <>
                        Integrates with WordPress, Webflow, Shopify, Framer and
                        many{' '}
                        <span className="text-primary-600 dark:text-primary-400 font-medium">
                          other platforms
                        </span>
