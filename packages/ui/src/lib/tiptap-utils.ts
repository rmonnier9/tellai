 ...
 * @param uploadAction The server action to upload the image
...
export const handleImageUpload = async (
  ...
  // Create FormData with file and articleId
  const formData = new FormData();
  formData.append('file', file);
  formData.append('articleId', articleId);

  try {
    // Simulate some progress (since we can't track actual upload progress with server actions)
