...
<div class="lovarank-container">
    <div class="lovarank-card">
        <div class="lovarank-header">
            <h2 class="lovarank-title">Lovarank Dashboard</h2>
            <form method="get" style="margin: 0;">
                <input type="hidden" name="page" value="lovarank_manage">
                <?php wp_nonce_field('lovarank_settings_action', 'lovarank_nonce'); ?>
                <button type="submit" name="btn_fetch" class="lovarank-fetch-btn">
        ...
        <div class="lovarank-table-container">
            <?php if (!empty($articles)) : ?>
                <table class="lovarank-table">
                    <thead>
                        <tr>
                            <th>Title</th>
                            <th>Slug</th>
