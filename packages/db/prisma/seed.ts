...
async function main() {
  ...
  const webflowCredential = await prisma.credential.create({
    data: {
      ...
      type: 'webflow',
      name: 'Webflow - Robins Exceptional Site',
      refreshToken: null,
      accessToken:
  ...
  const framerCredential = await prisma.credential.create({
    data: {
      id: 'cmh7gdydr0000vbvdbjwfx9jt',
      type: 'framer',
      name: 'Framer - Lovarank',
      refreshToken: null,
      accessToken: 'framer_u9wl634hjpqgjn3pp1ppch32foc3h74r',
      externalId: null,
      config: {},
      productId: clientProduct.id,
      createdAt: '2025-10-22T13:15:01.284Z',
  ...
  const article1 = await prisma.article.create({
    data: {
      ...
      slug: 'how-to-seed-your-prisma-database-effectively',
      type: 'guide',
      guideSubtype: 'how_to',
      searchVolume: 1200,
  ...
  const article2 = await prisma.article.create({
    data: {
      ...
      slug: 'how-to-run-a-successful-seo-campaign',
      type: 'guide',
      guideSubtype: 'how_to',
      searchVolume: 1200,
      keywordDifficulty: 45.5,
  ...
  const article3 = await prisma.article.create({
    data: {
      ...
      slug: 'how-to-generate-seo-content-with-ai',
      type: 'guide',
      guideSubtype: 'how_to',
      searchVolume: 1200,
      keywordDifficulty: 45.5,
